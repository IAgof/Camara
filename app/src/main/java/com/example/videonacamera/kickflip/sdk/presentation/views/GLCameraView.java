package com.example.videonacamera.kickflip.sdk.presentation.views;
...
public class GLCameraView extends GLSurfaceView {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        Log.d("Focus", "GLCameraView onTouchEvent");

        if(mScaleGestureDetector != null){
            if(!mScaleGestureDetector.onTouchEvent(ev)){
                // No scale gesture detected
                Log.d("Focus", "GLCameraView No scale gesture detected");
            }
        }
