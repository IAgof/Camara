...
import com.example.root.kickflip.sdk.av.gles.EglCore;
import com.example.root.kickflip.sdk.av.gles.EglStateSaver;
...
public class CameraEncoder implements SurfaceTexture.OnFrameAvailableListener, Runnable {
     ...
     *               providing a new {@link com.example.root.kickflip.sdk.av.SessionConfig} to avoid
     ...
     * make any subsequent recordings, or {@link #reset(com.example.root.kickflip.sdk.av.SessionConfig)} to prepare
